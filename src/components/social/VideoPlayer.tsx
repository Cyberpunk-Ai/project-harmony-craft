  ...
  return (
    ...
    >
      {src && !hasError ? (
        ...
        <div className="flex aspect-video w-full items-center justify-center bg-neutral-900 text-muted-foreground text-xs">
          Video source unavailable or format unsupported
        </div>
      )}
